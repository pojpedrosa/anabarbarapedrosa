    ...
    <header class="sticky top-0 z-50 bg-white border-b border-neutral-100">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                <a href="{{ route('home') }}" class="font-semibold text-base tracking-wide text-neutral-900">
                    Ana Bárbara Pedrosa
                </a>
        ...
        <div x-show="mobileMenu" x-transition class="md:hidden border-t border-neutral-100 bg-white">
            <nav class="flex flex-col px-5 py-4 gap-4 text-sm">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div class="flex items-center gap-6 text-sm text-neutral-400">
                    ...
                    @endphp
                    @if($instagram)<a href="{{ $instagram }}" target="_blank" rel="noopener" class="hover:text-neutral-700 transition-colors">Instagram</a>@endif
                    @if($facebook)<a href="{{ $facebook }}" target="_blank" rel="noopener" class="hover:text-neutral-700 transition-colors">Facebook</a>@endif
                    @if($linkedin)<a href="{{ $linkedin }}" target="_blank" rel="noopener" class="hover:text-neutral-700 transition-colors">LinkedIn</a>@endif
                </div>
